...
public class RedTwoBallHighGoal extends SequentialCommandGroup {
  ...
  public RedTwoBallHighGoal(IntakeSubsystem intakeSubsystem, DrivetrainSubsystem drivetrainSubsystem, ShooterSubsystem shooterSubsystem, Photon photon, ConveyorSubsystem conveyorSubsystem) {
